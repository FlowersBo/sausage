// pages/user/wallet/bindingBank/addBankCard/addBankCard.js
var that;
var app = getApp();
Page({
  ...
  getVerificationCode(e) {
    ...
    var bankPhone = that.data.bankPhone;
    if (bankCard == "") {
      wx.showToast({
        title: '银行卡号不能为空',
        icon: 'none',
  ...
  formSubmit(e) {
    ...
    var bankPhone = e.detail.value.bankPhone;
    ...
    if (bankCard == "") {
      ...
      return false;
    } else if (bankPhone.length < 2 || bankPhone.length >= 10) {
      wx.showToast({
        title: '请输入持卡人姓名',
        icon: 'none',
        duration: 1000
